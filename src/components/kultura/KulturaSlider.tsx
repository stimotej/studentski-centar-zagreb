...
export default function KulturaSlider({ slides, className }: SliderProps) {
  ...
  return (
    <div
      className={clsx(
        "group relative w-full h-[350px] rounded-lg overflow-hidden",
        className
      )}
    >
      {slides.map((slide, index) => (
        ...
        >
          ...
          ></div>
          <div
            className={`absolute top-1/2 left-6 text-center right-6 z-20 transform-gpu text-white [transition:transform_1s_ease,opacity_0.4s_ease] ${
              index === currentSlide

...
export default function KulturaSlider({ slides, className }: SliderProps) {
    ...
    >
      {slides.map((slide, index) => (
        ...
        >
          ...
          ></div>
          <div
            className={`absolute top-1/2 left-6 text-center right-6 z-20 transform-gpu text-white [text-shadow:0_1px_3px_rgba(0,0,0,0.65),0_0_6px_rgba(0,0,0,0.35)] [transition:transform_1s_ease,opacity_0.4s_ease] ${
              index === currentSlide
      ...
      <button
        className="hidden md:block absolute bottom-6 left-6 z-30 -translate-x-full transform-gpu text-xl text-white opacity-0 transition-[transform,opacity] group-hover:translate-x-0 group-hover:opacity-100"
        onClick={handlePrevSlide}
      >
        &#10094;
      </button>
      <button
        className="hidden md:block absolute bottom-6 right-6 z-30 translate-x-full transform-gpu text-xl text-white opacity-0 transition-[transform,opacity] group-hover:translate-x-0 group-hover:opacity-100"

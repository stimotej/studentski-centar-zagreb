...
const KvalitetaPrehraneSection: React.FC<KvalitetaPrehraneSectionProps> = (
  ...
  return (
    <section className={clsx("relative z-[2] bg-[#fafafa]", props.className)}>
      <Image
      ...
      <div className="flex flex-col md:flex-row gap-10 mt-12">
        <Card className="text-center flex-1">
          ...
          <p className="text-sm font-light leading-relaxed">
            Organizam i probava svake osobe se dovoljno razlikuju da isti režim
            prehrane može rezultirati sa drugačijim ishodima. Zato je bitno
            istražiti i testirati vlastiti organizam te prilagoditi režim
            prehrane tim potrebama.
          </p>
        </Card>
        <Card className="text-center flex-1">
          <h5 className="text-lg text-text font-semibold mb-4">

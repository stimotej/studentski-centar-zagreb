    ...
    <section className={props.className}>
      <div className="flex flex-col lg:flex-row gap-6 ">
        ...
        <div className="lg:w-1/3 lg:px-6">
          <SectionCard
            image="/sczg/slike/student-servis/ikone/potpis-ugovora.png"
...
Upozoravamo studente da nikome, nikad ništa ne <strong>potpisuju unaprijed</strong>."
      ...
      <div className="flex flex-col lg:flex-row gap-12 mt-8">
        <div className="flex-1">
          <SectionCard
            image="/sczg/slike/student-servis/ikone/isplate-naknada.png"
        ...
        <div className="transform lg:-translate-y-24 flex-1">
          <SectionCard
            image="/sczg/slike/student-servis/ikone/broj-ugovora.png"
            title="BROJ UGOVORA"
        ...
        <div className="flex-1">
          <SectionCard
            image="/sczg/slike/student-servis/ikone/neoporezivi-primitak.png"
